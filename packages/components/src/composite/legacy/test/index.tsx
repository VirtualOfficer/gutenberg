...
describe( 'Shows a deprecation warning', () => {
	...
	it( 'Composite', () => {
		...
		render( <Test /> );
		expect( console ).toHaveWarnedWith(
			'wp.components.__unstableComposite is deprecated since version 6.7. Please use Composite.Root instead.'
		);
	} );
	it( 'CompositeItem', () => {
		const Test = () => {
	...
	it( 'CompositeGroup', () => {
		...
		render( <Test /> );
		expect( console ).toHaveWarnedWith(
			'wp.components.__unstableCompositeGroup is deprecated since version 6.7. Please use Composite.Group instead.'
		);
	} );
} );
